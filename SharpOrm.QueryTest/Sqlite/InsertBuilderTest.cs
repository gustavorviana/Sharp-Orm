...
{
    public class InsertBuilderTest(ITestOutputHelper output, DbFixture<SqliteQueryConfig> connection) : DbGrammarTestBase(output, connection), IClassFixture<DbFixture<SqliteQueryConfig>>, IInsertBuilderTest
    {
        [Fact]
        ...
        public void Insert()
        {
            ...
            QueryAssert.EqualDecoded(
                "INSERT INTO \"TestTable\" (\"id\", \"name\", \"value\") VALUES (1, @p1, NULL); SELECT last_insert_rowid();",
                ["T1"],
        ...
        public void InsertByBasicSelect()
        {
            ...
            QueryAssert.Equal(
                "INSERT INTO \"TestTable\" (\"UserId\", \"Status\") SELECT \"Id\", 1 FROM \"User\" WHERE \"id\" = 1",
                sqlExpression
            );
        }
        ...
        public void InsertWithRaw()
        {
            ...
            QueryAssert.Equal(
                "INSERT INTO \"TestTable\" (\"id\") VALUES (1); SELECT last_insert_rowid();",

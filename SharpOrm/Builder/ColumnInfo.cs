...
namespace SharpOrm.Builder
{
    ...
    public class ColumnInfo : IEquatable<ColumnInfo>, IColumnInfo
    {
        ...
        internal ColumnInfo(MemberInfo member, IColumnInfo map, TranslationRegistry registry)
        {
            ...
            this.IsNative = TranslationUtils.IsNative(this.Type, false);

            this.AutoGenerated = map.AutoGenerated;
            this.Translation = map.Translation ?? registry.GetFor(this.Type);
            this.ForeignInfo = map.ForeignInfo;
            this.Validations = map.Validations;

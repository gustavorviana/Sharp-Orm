...
namespace SharpOrm.Builder
{
    public class ColumnMapInfo : IColumnInfo
    {
        ...
        bool IColumnInfo.IsJson => _isJson;
        ...
        internal ColumnMapInfo(MemberInfo member, TranslationRegistry registry)
        {
            ...
            _isJson = member.GetCustomAttribute<JsonAttribute>() != null;
        ...
        /// <summary>
        /// Marks the column as containing JSON data.
        /// </summary>
        public ColumnMapInfo IsJson()
        {
            this.CheckBuilded();
            this._isJson = true;
            return this;

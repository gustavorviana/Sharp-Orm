...
{
    /// <summary>
    /// Provides a fluent API for configuring column mappings in entity models.
    /// Allows customization of column names, types, validations, and foreign key relationships.
    /// </summary>
    public class ColumnMapInfo : IColumnInfo
    {
        ...
        private bool _isDatabaseGenerated;
        #endregion
        ...
        internal ColumnMapInfo(MemberInfo member, TranslationRegistry registry)
        {
            ...
            _foreignInfo = ColumnInfo.GetForeign(member);
            ...
            _isDatabaseGenerated = member.GetCustomAttribute<DatabaseGeneratedAttribute>() != null;
        }
        ...
        /// <summary>
        /// Sets the database provider specific data type name for the column.
        /// </summary>
        /// <param name="typeName">The name of the data type to set for the column.</param>
        /// <returns>The current <see cref="ColumnMapInfo"/> instance.</returns>
        public ColumnMapInfo HasTypeName(string typeName)
        {
            _typeName = typeName;
            return this;
        }
        ...
        public ColumnMapInfo SetForeign(string foreignKey, string localKey = "id")
        {
            ...
            _foreignInfo = new ForeignAttribute(foreignKey) { LocalKey = localKey };
        ...
        public ColumnMapInfo IsRequired()
        {
            if (!this.HasValidation<RequiredAttribute>())
                _validations.Add(new RequiredAttribute());
        ...
        public ColumnMapInfo HasMinLength(int length)
        {
            if (!this.HasValidation<MinLengthAttribute>())
                _validations.Add(new MinLengthAttribute(length));
        ...
        public ColumnMapInfo HasMaxLength(int length)
        {
            if (!this.HasValidation<MaxLengthAttribute>())
                _validations.Add(new MaxLengthAttribute(length));
        ...
        public ColumnMapInfo HasRange(int min, int max)
        {
            if (!this.HasValidation<RangeAttribute>())
                _validations.Add(new RangeAttribute(min, max));
        ...
        private bool HasValidation<T>() where T : ValidationAttribute
        {
            ...
            return _validations.Any(x => x is T);
        }
        ...
        /// <summary>
        /// Sets whether the column value is generated by the database (e.g., computed or identity columns).
        /// </summary>
        /// <param name="value">True if the column is database-generated; otherwise, false.</param>
        /// <returns>The current <see cref="ColumnMapInfo"/> instance.</returns>
        public ColumnMapInfo SetDatabaseGenerated(bool value)
        {
            _isDatabaseGenerated = value;
            return this;
        }

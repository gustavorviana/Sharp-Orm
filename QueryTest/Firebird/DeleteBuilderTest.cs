...
{
    public class DeleteBuilderTest(ITestOutputHelper output, MockFixture<FbQueryConfig> connection) : DbGrammarTestBase(output, connection), IClassFixture<MockFixture<FbQueryConfig>>, IDeleteBuilderTest
    {
        [Fact]
        ...
        [Fact]
        public void DeleteWhereAndLimit()
        {
            using var query = new Query(TestTableUtils.TABLE);
            query.Limit = 5;

...
{
    public class UpdateBuilderTest(ITestOutputHelper output, MockFixture<FbQueryConfig> connection) : DbGrammarTestBase(output, connection), IClassFixture<MockFixture<FbQueryConfig>>, IUpdateBuilderTest
    {
        [Theory]

...
namespace QueryTest.Sqlite
{
    ...
    {
        public StringMapTest() : base(new SqliteQueryConfig())
        {
        }
        ...
        public void SubstringWithColumnIndex()
        {
            ...
            Assert.Equal("SUBSTR(\"Name\",\"StartIndex\",10) AS \"Name\"", column.ToString());
        }
        ...
        public void SubstringByIndexColumns()
        {
            ...
            Assert.Equal("SUBSTR(\"Name\",\"StartIndex\",\"EndIndex\") AS \"Name\"", column.ToString());
        }
    }
}

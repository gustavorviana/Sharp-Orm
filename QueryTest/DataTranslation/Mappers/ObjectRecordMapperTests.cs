...
namespace QueryTest.DataTranslation.Mappers
{
    public class ObjectRecordMapperTests : DbMockTest
    {
        ...
        public void MapSimpleObject_ShouldReadCorrectly()
        {
            ...
            var mapper = new ObjectRecordMapper(tableInfo, reader, Translation);
        ...
        public void Constructor_WithNullReader_ShouldThrowArgumentNullException()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => new ObjectRecordMapper(tableInfo, null, Translation));
        }
        ...
        public void Constructor_WithNullRegistry_ShouldThrowArgumentNullException()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => new ObjectRecordMapper(tableInfo, reader, null));
        }

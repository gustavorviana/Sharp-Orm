...
{
    public class CountBuilderTest(ITestOutputHelper output, MockFixture<MysqlQueryConfig> connection) : DbGrammarTestBase(output, connection), IClassFixture<MockFixture<MysqlQueryConfig>>, ICountBuilderTest
    {
        [Fact]
        public void Count()
        {

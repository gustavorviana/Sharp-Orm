...
{
    [TestClass]
    public class SqliteCommandRunTest : SqliteTableTest
    {
        [TestMethod]
        public void Insert()
        {
        ...
        {
            var config = new SqliteQueryConfig(false) { LoadForeign = true };
            const uint Id = 1;
            const int Addr = 1;
            const string Name = "User 1";
        ...
        public void Upsert()
        {
            ...
            Assert.AreEqual(1L, query.FirstRow()[ID]);
        ...
        public void DeleteWhereJoin()
        {
            ...
            Assert.ThrowsException<NotSupportedException>(() => qOrder.Delete());
        }
        ...
        public void UpdateJoin()
        {
            ...
            qOrder.Join<Customer>("c", "c.id", "orders.customer_id");
            qOrder.Where("c.name", "Ronaldo");
            Assert.ThrowsException<NotSupportedException>(() => qOrder.Update(new Cell("Status", "Processed")));
        }

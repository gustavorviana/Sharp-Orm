...
namespace UnityTest
{
    ...
    public class MysqlInsertUpdateDeleteBuilderTest : MysqlTableTest
    {
        ...
        public void Insert()
        {
            ...
            TestAssert.AreDecoded("INSERT INTO `TestTable` (`id`, `name`, `value`) VALUES (1, @p1, NULL); SELECT LAST_INSERT_ID();", sqlExpression);
        ...
        public void InsertWIthRaw()
        {
            ...
            TestAssert.AreDecoded("INSERT INTO `TestTable` (`id`) VALUES (1); SELECT LAST_INSERT_ID();", sqlExpression);
        }
        ...
        public void InsertExtendedClass()
        {
            ...
            TestAssert.AreDecoded("INSERT INTO `TestTable` (`Id`, `Name`, `Nick`, `record_created`, `Number`, `custom_id`, `custom_status`) VALUES (1, @p1, NULL, @p2, 2.1, @p3, 1); SELECT LAST_INSERT_ID();", sqlExpression);
        ...
        public void DeleteLimit()
        {
            ...
            var sqlExpression = g.Delete();
            TestAssert.AreDecoded("DELETE FROM `TestTable` LIMIT 5", sqlExpression);
        }
        ...
        public void DeleteOrder()
        {
            ...
            var sqlExpression = g.Delete();
            TestAssert.AreDecoded("DELETE FROM `TestTable` ORDER BY `id` Asc", sqlExpression);
        }
        ...
        public void DeleteWhereJoin()
        {
            ...
            var sqlExpression = g.Delete();
            TestAssert.AreDecoded("DELETE `t1` FROM `TestTable` `t1` INNER JOIN `Table2` `t2` ON `t2`.`Id` = `t1`.`T2Id` WHERE `t2`.`Id` = 1", sqlExpression);
        }
        ...
        public void DeleteJoins()
        {
            ...
            var sqlExpression = g.Delete();
            TestAssert.AreDecoded("DELETE `t1`, `t2` FROM `TestTable` `t1` INNER JOIN `Table2` `t2` ON `t2`.`Id` = `t1`.`T2Id` WHERE `t2`.`Id` = 1", sqlExpression);
        }

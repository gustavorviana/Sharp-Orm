...
{
    [TestClass]
    public class FblSelectBuilderTest : FbTableTest
    {
        [TestMethod]
        ...
        public void SelectWithLimit()
        {
            ...
            var sqlExpression = g.Select();
            TestAssert.AreDecoded("SELECT * FROM TestTable ROWS 11", sqlExpression);
        }
        ...
        public void SelectWithOffsetLimit()
        {
            ...
            var sqlExpression = g.Select();
            TestAssert.AreDecoded("SELECT * FROM TestTable ROWS 11 TO 20", sqlExpression);
        }
        ...
        public void SelectWithOffsetLimitDistinct()
        {
            ...
            var sqlExpression = g.Select();
            TestAssert.AreDecoded("SELECT DISTINCT * FROM TestTable ROWS 11 TO 20", sqlExpression);
        }
        ...
        public void SelectLimitWhere()
        {
            ...
            var sqlExpression = g.Select();
            TestAssert.AreDecoded("SELECT * FROM TestTable WHERE column = @p1 ROWS 11", sqlExpression);
            TestAssert.AreEqualsParameters(sqlExpression, 0);
        }
        ...
        public void SelectWithEscapeStrings()
        {
            ...
            var config = new FbQueryConfig(false) { LoadForeign = true, EscapeStrings = true };
